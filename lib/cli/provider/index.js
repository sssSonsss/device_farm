...
module.exports.handler = function(argv) {
  ...
  , filter: function(device) {
      // ORIGINAL: return argv.serial.length === 0 || argv.serial.indexOf(device.id) !== -1
      // PATCHED: Force accept all devices to fix filtering issue
      console.log('FILTER: Accepting device', device.id);
      return true;
    }
