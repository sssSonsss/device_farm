...
module.exports = function(options) {
  ...
  if (fs.existsSync('/app/static/app/build')) {
    log.info('Using pre-built resources from /app/static/app/build')
    app.use(compression())
    app.use('/static/app/build/entry',
      serveStatic('/app/static/app/build/entry'))
    app.use('/static/app/build', serveStatic('/app/static/app/build', {
      maxAge: '10d'
    }))
  }
  else {
